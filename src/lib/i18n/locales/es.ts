...
export const es: Dictionary = {
  ...
  contact: {
    ...
    description:
      "Escribime sobre tu proyecto, una oportunidad laboral o simplemente para saludar. Te respondo a la brevedad.",
    nameLabel: "Nombre",
    emailLabel: "Correo electrónico",
    messageLabel: "Contame tu idea",
    ...
    errors: {
      ...
      messageRequired: "Escribí un mensaje antes de enviar.",
      generic: "Algo salió mal al enviar el mensaje. Intentá de nuevo en unos minutos.",
    },
  },
  footer: {
