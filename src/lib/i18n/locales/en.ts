...
export const en: Dictionary = {
  ...
  contact: {
    ...
    description:
      "Reach out about a project, a job opportunity, or just to say hi. I'll get back to you shortly.",
    nameLabel: "Name",
    emailLabel: "Email address",
    messageLabel: "Tell me your idea",
    submit: "Send message",
    submitting: "Sending...",
    ...
    errors: {
      ...
      generic: "Something went wrong while sending. Please try again in a few minutes.",
    },
  },
  footer: {
